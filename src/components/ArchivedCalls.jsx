    ...
    <div>
      { activities.map((activity)=>(
        activity.is_archived && <div key={activity.id} style={{margin:"20px"}}>
            ...
            borderRadius: "3px",
            boxShadow: "0 0 5px 0 rgba(0, 0, 0, .9)", padding: "10px", display: "flex", flexDirection:"row", alignItems:"center",
            justifyContent:"space-between"}}>
                    ...
                    <button onClick={(e)=>onClickHandler(activity.id, activity.is_archived)} style={{backgroundColor: "#40c420", color: "white", border:"2px solid white", borderRadius:"3px", boxShadow: "0 0 5px 0 rgba(0, 0, 0, .9)"}}>UNARCHIVE</button>
                </div>
